...
pattern="[0-9][0-9]{4}" title="Cardnumber should have 6 digits" required autofocus />
...
<div class="row">
<div class="col-xs-12">
<button class="btn btn-success btn-lg btn-block" type="submit"><a href="ThankyouPage">Checkout</a></button>
</div>
</div>
